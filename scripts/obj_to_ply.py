...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_samples', type=int, default=2_000_000, help='Number of samples to take from the mesh')
    parser.add_argument('--ascii', action='store_true', help='Save as ASCII instead of binary')
    parser.add_argument('--create_meshlab', action='store_true', help='Create an additional .ply file compatible with Meshlab')
